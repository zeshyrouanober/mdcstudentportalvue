<template lang="html">
  <div class="faqs-container">
    ...
    <div class="system-identification-container" >
      ...
      <br><br>
      <div class="tips-container section scrollspy wow fadeInUp z-depth-1 white" id="system-tips">
        <div class="tips-title blue">
      ...
      <div class="school-header section scrollspy white z-depth-1 " id="school-header">
        ...
        <div class="school-seal wow fadeInUp">
          ...
          <label>
            ...
            The words SAPIENTA , <b>wisdom</b> through Scholarship, CARITAS, <b>charity</b> , through Service, and ORATIO, <b>prayer-life</b> through living the Gospel are the corporate values that the College upholds.
          </label>
        </div>
      </div>
      <br><br>
